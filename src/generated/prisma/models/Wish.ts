...
export type WishWhereInput = {
  ...
  likes?: Prisma.IntFilter<"Wish"> | number
...
export type WishScalarWhereWithAggregatesInput = {
  ...
  likes?: Prisma.IntWithAggregatesFilter<"Wish"> | number
...
export type WishOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "message" | "likes" | "createdAt", ExtArgs["result"]["wish"]>
...
export interface WishFieldRefs {
  ...
  readonly likes: Prisma.FieldRef<"Wish", 'Int'>
